...
public class ControlPanel extends JFrame {
   ...
   public static final Color RED_OFF = new Color(255, 0, 0, 50);
   public static final Color RED_ON = new Color(255, 0, 0, 255);
   public static final Color GREEN_OFF = new Color(0, 255, 0, 50);
   public static final Color GREEN_ON = new Color(0, 255, 0, 255);
   public static final Color YELLOW_OFF = new Color(255, 255, 0, 50);
   public static final Color YELLOW_ON = new Color(255, 255, 0, 255);
   public static final Map<Color, Color> onOff = new HashMap<Color, Color>() {{
      put(RED_OFF, RED_ON);
      put(RED_ON, RED_OFF);
